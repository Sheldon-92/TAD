...
**Anti-pattern**: Allowing flaky tests to persist. They erode confidence in the entire suite. Teams start ignoring failures. Then real bugs ship.
...
# Target: >= 80% mutation score on business logic
```
