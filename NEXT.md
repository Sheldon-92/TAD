...
- [x] **EPIC: Trajectory Eval Harness — Phase 2/3 ✅ ACCEPTED 2026-07-02** (commits aa8aeaf + 8d7b767, Gate 3 PASS + Gate 4 PASS — Alex recomputed ALL metrics from 24 raw JSONs, bit-identical to Blake's report) — **Judge is CALIBRATED: calibration_verdict: PASS.** Round2: within-1 94.1% (32/34, floor 27 OK), contrast 1.75 (D4-excluded per Phase-1 prestatement; P1 ambiguity adjudicated — round1 FAILed under BOTH readings so no metric-shopping), anti-anchor GS-06 3.75, stability probe max Δ=1. Round1 88.2% + contrast FAIL → D2 Evidence Scope Rule added to judge-prompt (golden + rubric verified untouched via git diff). New L2 pattern: "Pre-Declared Exclusion Must Be Restated in Every Gate Metric" (ac-verification.md). Gate 4 report: `.tad/evidence/acceptance-tests/trajectory-eval-p2/gate4-acceptance-report.md`. Handoff archived. **Phase 3 UNBLOCKED (final phase): Gate 4 judge evidence integration + 30-day Gate-ROI report.** Carry-forward: thin contrast margin (0.25), judge-prompt frozen post-calibration, GS-07.D3 label review deferred to post-Epic. Epic: `.tad/active/epics/EPIC-20260701-trajectory-eval-harness.md`
