...
Codex roles use a shared `.tad/` knowledge, state, and journal
...
- This is a short routing index, not a copy of project-knowledge prose. If the
  knowledge index gains a file, update this index too; no mechanical verifier
  currently joins the two lists.
...
5. Otherwise: suggest "Say '当 Alex' to design, '当 Blake' to implement" (Lite is frozen — only offer it if the user names it)
