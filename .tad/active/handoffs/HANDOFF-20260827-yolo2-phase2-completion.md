...
scope_proof_amendment_r2: .tad/decisions/DR-20260831-yolo2-phase2-scope-proof-amendment-r2.md
...
**Scope-proof amendment R2**: `.tad/decisions/DR-20260831-yolo2-phase2-scope-proof-amendment-r2.md`
（人类签署；纠正 `f967276f` provenance hash，以四个精确 fixed exclusions 取代通用路径放行）
