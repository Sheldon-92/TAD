...
/path/to/TAD/.tad/evidence/acceptance-tests/lite-core-closure/scenarios/S2-blake-no-distill/fixture-lite-handoff.md
...
/path/to/TAD/.tad/evidence/acceptance-tests/lite-core-closure/scenarios/S2-blake-no-distill/raw-transcript.txt
