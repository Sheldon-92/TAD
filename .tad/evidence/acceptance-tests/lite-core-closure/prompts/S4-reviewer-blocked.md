...
You are Blake-Lite. Read and follow /path/to/TAD/.claude/skills/blake-lite/SKILL.md exactly.

Your LITE handoff is:
/path/to/TAD/.tad/evidence/acceptance-tests/lite-core-closure/scenarios/S4-reviewer-blocked/fixture-lite-handoff.md
...
/path/to/TAD/.tad/evidence/acceptance-tests/lite-core-closure/scenarios/S4-reviewer-blocked/raw-transcript.txt
