...
You are Blake-Lite. Read and follow /path/to/TAD/.claude/skills/blake-lite/SKILL.md exactly — especially the Lite Repair Loop and Lite Technical Gate rules.

Your LITE handoff is:
/path/to/TAD/.tad/evidence/acceptance-tests/lite-core-closure/scenarios/S6-repair-circuit/fixture-lite-handoff.md
...
/path/to/TAD/.tad/evidence/acceptance-tests/lite-core-closure/scenarios/S6-repair-circuit/raw-transcript.txt
