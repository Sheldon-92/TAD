  ...
  execution:
    ...
    step3:
      ...
      action: |
        ...
        b2. [REMOVED — pack skills are now copied directly via cp -R (merge) in step b1,
            matching tad.sh behavior. The standalone pack installer is no longer invoked during *sync.
            Pack meta (.tad-pack-meta.yaml) is generated by tad.sh after copy.
            The mirror is authoritative — no secondary regeneration step.]
        ...
        d2. Self-Deriving Release Verification Gate (structural — BLOCKING on minor+):
           ...
           equality test (edition transforms are a P2/tad.sh concern, out of this gate's scope).
        ...
        - .tad/pair-testing/
        - .tad/decisions/
        - .tad/capability-packs/ (source dirs NOT synced — pack skills copied directly via cp -R merge in step b1)
