---
name: tad-elicit
description: Start requirement elicitation with mandatory 3-5 rounds of structured questioning.
---
...
[[LLM: This command immediately starts the requirement elicitation process with Agent A persona, enforcing all mandatory rules from TAD v2.5.0.]]