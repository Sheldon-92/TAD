...
| release_sync_install | codex_adapter | tad.sh --platform codex --yes installs to .agents/skills/ and generates the current hooks schema; .agents/skills is the sole source of truth (v3.0.0) | local codex --help + tad.sh + release-verify.sh structural (2026-08-03) | codex-cli 0.146.0 | 2026-08-03 | low | 2026-09-02 | no | Manual file copy | verified |
