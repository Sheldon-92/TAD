...
| context_compaction | codex_adapter | Automatic compaction produces a continuation summary; compaction hook surfaces remain documented; session-state.md is recovery fallback | https://learn.chatgpt.com/docs/compaction (retrieved 2026-08-03) | codex-cli 0.146.0 | 2026-08-03 | medium | 2026-09-02 | yes | session-state.md file-based recovery (platform-agnostic) | verified |
