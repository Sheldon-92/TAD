#!/usr/bin/env bash
# install.sh — Web Testing Capability Pack installer
...
echo "=== Web Testing Capability Pack Installer ==="
...
case "$AGENT" in
  ...
  codex)
    ...
    echo "   AGENTS.md (project root, appended with 'web-testing' role reference)" >&2
  ...
  cursor)
    ...
    echo "   Phase 3 will install to:" >&2
    echo "   .cursor/rules/web-testing.md" >&2
    echo "   For now, install with --agent=claude-code and adapt manually." >&2
    exit 2
    ;;
  gemini)
...
TARGET_DIR="${CLAUDE_DIR}/skills/web-testing"
...
declare -a COPY_PAIRS=(
  ...
  "references/unit-testing-rules.md:${TARGET_DIR}/references/unit-testing-rules.md"
  "references/api-testing-rules.md:${TARGET_DIR}/references/api-testing-rules.md"
  "references/performance-testing-rules.md:${TARGET_DIR}/references/performance-testing-rules.md"
  "references/accessibility-testing-rules.md:${TARGET_DIR}/references/accessibility-testing-rules.md"
  "references/pair-testing-rules.md:${TARGET_DIR}/references/pair-testing-rules.md"
  "references/test-strategy-rules.md:${TARGET_DIR}/references/test-strategy-rules.md"
)
...
echo "  Reference 'web-testing' skill in your conversation."
echo "  Or: 'Use the web-testing capability pack to review this test setup.'"
