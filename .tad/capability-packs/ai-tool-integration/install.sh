#!/usr/bin/env bash
# install.sh — AI Tool Integration Capability Pack installer
...
echo "=== AI Tool Integration Capability Pack Installer ==="
...
case "$AGENT" in
  ...
  codex)
    ...
    echo "   AGENTS.md (project root, appended with 'ai-tool-integration' role reference)" >&2
  ...
  cursor)
    ...
    echo "   Phase 3 will install to:" >&2
    echo "   .cursor/rules/ai-tool-integration.md" >&2
    echo "   For now, install with --agent=claude-code and adapt manually." >&2
    exit 2
    ;;
  gemini)
...
TARGET_DIR="${CLAUDE_DIR}/skills/ai-tool-integration"
...
declare -a COPY_PAIRS=(
  ...
  "references/mcp-server-dev-rules.md:${TARGET_DIR}/references/mcp-server-dev-rules.md"
  "references/cli-tool-wrapping-rules.md:${TARGET_DIR}/references/cli-tool-wrapping-rules.md"
  "references/api-integration-rules.md:${TARGET_DIR}/references/api-integration-rules.md"
  "references/tool-schema-rules.md:${TARGET_DIR}/references/tool-schema-rules.md"
  "references/tool-permission-rules.md:${TARGET_DIR}/references/tool-permission-rules.md"
  "references/tool-testing-rules.md:${TARGET_DIR}/references/tool-testing-rules.md"
  "references/tool-documentation-rules.md:${TARGET_DIR}/references/tool-documentation-rules.md"
)
...
echo "  Reference 'ai-tool-integration' skill in your conversation."
echo "  Or: 'Use the ai-tool-integration capability pack to review this MCP server.'"
