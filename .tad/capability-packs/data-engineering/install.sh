#!/usr/bin/env bash
# install.sh — Data Engineering Capability Pack installer
...
echo "=== Data Engineering Capability Pack Installer ==="
...
case "$AGENT" in
  ...
  codex)
    ...
    echo "   AGENTS.md (project root, appended with 'data-engineering' role reference)" >&2
  ...
  cursor)
    ...
    echo "   Phase 3 will install to:" >&2
    echo "   .cursor/rules/data-engineering.md" >&2
    echo "   For now, install with --agent=claude-code and adapt manually." >&2
    exit 2
    ;;
  gemini)
...
TARGET_DIR="${CLAUDE_DIR}/skills/data-engineering"
...
declare -a COPY_PAIRS=(
  ...
  "references/ingestion-rules.md:${TARGET_DIR}/references/ingestion-rules.md"
  "references/transformation-stack-rules.md:${TARGET_DIR}/references/transformation-stack-rules.md"
  "references/orchestration-rules.md:${TARGET_DIR}/references/orchestration-rules.md"
  "references/data-quality-rules.md:${TARGET_DIR}/references/data-quality-rules.md"
  "references/dimensional-modeling-rules.md:${TARGET_DIR}/references/dimensional-modeling-rules.md"
  "references/vector-streaming-rules.md:${TARGET_DIR}/references/vector-streaming-rules.md"
)
...
echo "  Reference 'data-engineering' skill in your conversation."
echo "  Or: 'Use the data-engineering capability pack to review this pipeline.'"
