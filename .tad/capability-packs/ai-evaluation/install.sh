#!/usr/bin/env bash
# install.sh — AI Evaluation Capability Pack installer
...
echo "=== AI Evaluation Capability Pack Installer ==="
...
case "$AGENT" in
  ...
  codex)
    ...
    echo "   AGENTS.md (project root, appended with 'ai-evaluation' role reference)" >&2
  ...
  cursor)
    ...
    echo "   Phase 3 will install to:" >&2
    echo "   .cursor/rules/ai-evaluation.md" >&2
    echo "   For now, install with --agent=claude-code and adapt manually." >&2
    exit 2
    ;;
  gemini)
...
TARGET_DIR="${CLAUDE_DIR}/skills/ai-evaluation"
...
declare -a COPY_PAIRS=(
  ...
  "references/benchmark-rules.md:${TARGET_DIR}/references/benchmark-rules.md"
  "references/regression-rules.md:${TARGET_DIR}/references/regression-rules.md"
  "references/ab-testing-rules.md:${TARGET_DIR}/references/ab-testing-rules.md"
  "references/adversarial-rules.md:${TARGET_DIR}/references/adversarial-rules.md"
  "references/pipeline-rules.md:${TARGET_DIR}/references/pipeline-rules.md"
  "references/eval-framework-workflow.md:${TARGET_DIR}/references/eval-framework-workflow.md"
  "references/human-eval-protocol.md:${TARGET_DIR}/references/human-eval-protocol.md"
)
...
echo "  Reference 'ai-evaluation' skill in your conversation."
echo "  Or: 'Use the ai-evaluation capability pack to review this eval setup.'"
