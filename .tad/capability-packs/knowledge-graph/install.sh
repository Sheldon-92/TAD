#!/usr/bin/env bash
# install.sh — Knowledge Graph & GraphRAG Capability Pack installer
...
echo "=== Knowledge Graph & GraphRAG Capability Pack Installer ==="
...
case "$AGENT" in
  ...
  codex)
    ...
    echo "   AGENTS.md (project root, appended with 'knowledge-graph' role reference)" >&2
  ...
  cursor)
    ...
    echo "   Phase 3 will install to:" >&2
    echo "   .cursor/rules/knowledge-graph.md" >&2
    echo "   For now, install with --agent=claude-code and adapt manually." >&2
    exit 2
    ;;
  gemini)
...
TARGET_DIR="${CLAUDE_DIR}/skills/knowledge-graph"
...
declare -a COPY_PAIRS=(
  ...
  "references/graphrag-architecture.md:${TARGET_DIR}/references/graphrag-architecture.md"
  "references/kg-construction.md:${TARGET_DIR}/references/kg-construction.md"
  "references/entity-resolution.md:${TARGET_DIR}/references/entity-resolution.md"
  "references/graph-database.md:${TARGET_DIR}/references/graph-database.md"
  "references/query-translation.md:${TARGET_DIR}/references/query-translation.md"
)
...
echo "  Reference 'knowledge-graph' skill in your conversation."
echo "  Or: 'Use the knowledge-graph capability pack to review this GraphRAG design.'"
