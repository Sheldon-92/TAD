#!/usr/bin/env bash
# install.sh — AI Guardrails Capability Pack installer
...
echo "=== AI Guardrails Capability Pack Installer ==="
...
case "$AGENT" in
  ...
  codex)
    ...
    echo "   AGENTS.md (project root, appended with 'ai-guardrails' role reference)" >&2
  ...
  cursor)
    ...
    echo "   Phase 3 will install to:" >&2
    echo "   .cursor/rules/ai-guardrails.md" >&2
    echo "   For now, install with --agent=claude-code and adapt manually." >&2
    exit 2
    ;;
  gemini)
...
TARGET_DIR="${CLAUDE_DIR}/skills/ai-guardrails"
...
declare -a COPY_PAIRS=(
  ...
  "references/prompt-injection-defense.md:${TARGET_DIR}/references/prompt-injection-defense.md"
  "references/content-moderation.md:${TARGET_DIR}/references/content-moderation.md"
  "references/pii-deidentification.md:${TARGET_DIR}/references/pii-deidentification.md"
  "references/output-validation.md:${TARGET_DIR}/references/output-validation.md"
  "references/defense-architecture.md:${TARGET_DIR}/references/defense-architecture.md"
)
...
echo "  Reference 'ai-guardrails' skill in your conversation."
echo "  Or: 'Use the ai-guardrails capability pack to review this LLM/agent security setup.'"
