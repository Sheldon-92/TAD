...
**Version 2.10.2 - Global Skill Exclusion + Tool Quick Reference**
...
your-project/
├── .tad/
│   ├── config.yaml              # v2.10.2 configuration (modular: 6 config files)
...
|---------|--------------|
| **v2.10.2** | **Global Skill Exclusion + Tool Quick Reference — prevents global skills from shadowing TAD methods; tool-quick-reference-alex/blake.md loaded at activation (CLI paths for NotebookLM/Codex/Gemini/gh); archived 5 conflicting skills; fixed stale version strings in Alex/Blake SKILL** |
...
**Welcome to TAD v2.10.2 - Global Skill Exclusion + Tool Quick Reference for AI-Assisted Development.**
