...
**Version 2.9.1 - Cross-Model Orchestration + NotebookLM Knowledge Layer**
...
your-project/
├── .tad/
│   ├── config.yaml              # v2.9.1 configuration (modular: 6 config files)
...
**Welcome to TAD v2.9.1 - Cross-Model Orchestration + NotebookLM Knowledge Layer for AI-Assisted Development.**
