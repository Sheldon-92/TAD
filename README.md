...
**Version 2.20.0 - Agent-Adjacent Pack Factory**
...
your-project/
├── .tad/
│   ├── config.yaml              # v2.20.0 configuration (modular: 6 config files)
...
**Welcome to TAD v2.20.0 - Agent-Adjacent Pack Factory
