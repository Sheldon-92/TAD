...
**Version 2.14.1 - Research Adversarial Challenge**
...
your-project/
├── .tad/
│   ├── config.yaml              # v2.14.1 configuration (modular: 6 config files)
...
**Welcome to TAD v2.14.1 - Research Adversarial Challenge for AI-Assisted Development.**
