...
**Version 2.14.0 - YOLO Mode + LSP Code Understanding**
...
your-project/
├── .tad/
│   ├── config.yaml              # v2.14.0 configuration (modular: 6 config files)
...
**Welcome to TAD v2.14.0 - YOLO Mode + LSP Code Understanding for AI-Assisted Development.**
