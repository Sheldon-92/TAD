...
**Version 2.22.1 - Self-Deriving Release/Sync**
...
your-project/
├── .tad/
│   ├── config.yaml              # v2.22.1 configuration (modular: 6 config files)
...
**Welcome to TAD v2.22.1 - Self-Deriving Release/Sync
