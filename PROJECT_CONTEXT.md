...
## Current State
- **Version**: 3.0.0 (Full is the default channel, lite frozen 2026-08-13 + Lite core closure + 25 capability packs + brain-native knowledge search + Claude Science skill architecture + Claude Code path removed, Codex sole runtime)
- **Last Updated**: 2026-09-16
- **Framework**: TAD v3.0.0 + Full-default/Lite-frozen + 25 Capability Packs + Codex-sole-runtime + Local Wiki Research + Compact Recovery
...
- NotebookLM is retained only as fallback; all 34 registry notebooks are archived locally. Local Wiki is the primary research path.
