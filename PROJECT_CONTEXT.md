...
## Current State
- **Version**: 2.44.4 (Full is the default channel, lite frozen 2026-08-13 + Lite core closure + 25 capability packs + brain-native knowledge search + Claude Science skill architecture)
- **Last Updated**: 2026-09-07
- **Framework**: TAD v2.44.4 + Full-default/Lite-frozen + 25 Capability Packs + Dual-Platform (Claude Code + Codex) + Local Wiki Research + Compact Recovery
